...
void add_hardreg(G::Graph<TEMP::Temp> *g)
{
  ...
  hardreg = new TEMP::TempList(F::F_RBP(), new TEMP::TempList(F::F_RAX(), new TEMP::TempList(F::F_RBX(), new TEMP::TempList(F::F_R12(), new TEMP::TempList(F::F_R13(), new TEMP::TempList(F::F_R14(), new TEMP::TempList(F::F_R15(),
